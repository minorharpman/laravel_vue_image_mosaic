<template>
    <div class="container-fluid">
      ...
      <div id="canvas_wrapper"  style="max-width:100%; max-height: 500px;overflow: scroll; display:none;">
          <canvas id="canvas" ref="myCanvas"   width="1000px" height="600px"></canvas>
          <br><br>
        <a id="download" download="mymosaic.jpg" href=""  @click="downloadMosaic()" >Download the Mosaic</a>  
      </div> 
  ...
  <div   v-if="images" class="row">
    <gallery :images="images" :index="index" @close="index = null"></gallery>
      ...
      >
         ...
         <a  @click="onoffpicture($event, image.id)" style=" cursor: pointer;color:black;background:white; opacity: 1 !important;">ON</a>  <a  @click="index = imageIndex" style=" cursor: pointer;color:black;background:#ccc; ">GALLERY</a><br>

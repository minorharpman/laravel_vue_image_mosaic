...
<div class="form-group m-2"><input type="radio" class="m-2" value="overlay" v-model="mosaic_effect" > Overlay | &nbsp;  &nbsp; </div>
<div class="form-group m-2"><input type="radio" class="m-2" value="lighter" v-model="mosaic_effect" > Lighter |  &nbsp; &nbsp;</div>

<div class="form-group m-2"><input type="radio" class="m-2" value="exclusion" v-model="mosaic_effect" > Exclusion |  &nbsp;&nbsp;</div>
<div class="form-group m-2"><input type="radio" class="m-2" value="multiply" v-model="mosaic_effect" > Multiply |  &nbsp;&nbsp;</div>

<div class="form-group m-2 "><input type="radio" class="m-2" value="soft-light" v-model="mosaic_effect" > Soft-light |  &nbsp;&nbsp;</div>


<div class="form-group m-2"><input type="radio" class="m-2" value="hard-light" v-model="mosaic_effect" > Hard-light |  &nbsp;&nbsp;</div>


<div class="form-group m-2"><input type="radio" class="m-2" value="darken" v-model="mosaic_effect" > Darken |  &nbsp;&nbsp;</div>

<div class="form-group m-2"><input type="radio" class="m-2" value="color-dodge" v-model="mosaic_effect" > Color-dodge |  &nbsp;&nbsp;</div>
<div class="form-group m-2"><input type="radio" class="m-2" value="color-burn" v-model="mosaic_effect" > Color-burn |  &nbsp;&nbsp;</div>

<div class="form-group m-2 "><input type="radio" class="m-2" value="luminosity" v-model="mosaic_effect" > Luminosity |  &nbsp;&nbsp;</div>
...
<div class="col-sm-12 mt-5">
   <div class="form-inline ">   
      ...
      <!--
        Nincs szükség erre a gombra, de itt hagyni
        <input type="checkbox" value=true  v-model="mosaic_saturate_status"> 
      -->
     Saturate:&nbsp;&nbsp;<input type="range" class="form-control-range" v-model="mosaic_saturate" >&nbsp;&nbsp;:{{mosaic_saturate}}
...
<div class="col-sm-12 mt-5">
    ...
    <div class="form-inline ">  
    Opacity:&nbsp;&nbsp;<input type="range" class="form-control-range" v-model="mosaic_opacity" >&nbsp;&nbsp;:{{mosaic_opacity}} 
     <!-- <b-form-slider v-model="mosaic_opacity"   :min="0" :max="100" trigger-change-event ></b-form-slider> -->
...
<div class="col-sm-12 mt-5">
    <div class="form-inline ">
     Threshold:&nbsp;&nbsp;<input type="range" class="form-control-range" v-model="mosaic_threshold" >&nbsp;&nbsp;:{{mosaic_threshold}} 
      
      <!--<b-form-slider v-model="mosaic_threshold"  :min="0" :max="255" trigger-change-event ></b-form-slider>-->
...
<div class="col-sm-12 mb-3">
  <div class="form-inline ">
      <div class="form-group m-2 mosaic_part_big "><input type="radio" class="m-2" value="20" v-model="mosaic_part_size" > 20x20 &nbsp;&nbsp;</div>
      <div class="form-group m-2 mosaic_part_big  "><input type="radio" class="m-2" value="10" v-model="mosaic_part_size" > 10x10 &nbsp;&nbsp;</div>
      <div class="form-group m-2"><input type="radio" class="m-2" value="5" v-model="mosaic_part_size" > 5x5 &nbsp;&nbsp;</div>
      <div class="form-group m-2"><input type="radio" class="m-2" value="3" v-model="mosaic_part_size" > 3x3 &nbsp;&nbsp;</div>
      <div class="form-group m-2"><input type="radio" class="m-2" value="2" v-model="mosaic_part_size" > 2x2 &nbsp;&nbsp;</div>  
      <div class="form-group m-2"><input type="radio" class="m-2" value="1" v-model="mosaic_part_size" > 1x1 &nbsp;&nbsp;</div>  
 </div>   
</div>
...
<!--
       ...
       -->
            ...
            <div class="form-group">
             ...
             <div id="make_mosaic" class="col-sm-12 mt-3 d-none d-lg-block">
    ...
    data() {
        return {
           ...
           // images: [],
            ...
            mosaic_part_size: 5, //mobil first
  ...
  //console.log(" effect"+this.mosaic_effect);
     ...
     var k = 0;
         for ( var i = 0; i < mosaic_row ; i++) { 
            ...
            ctx.textAlign = "left";
            ctx.fillStyle = "white";
            ctx.fillRect(0, canvas_height- 18, 90, 20);
            ctx.fillStyle = "black";
            ctx.fillText( "blogbook.hu" , 5, canvas_height-5); 
...
,
      ...
      if(this.window_width < 1300){
             ...
             $(".mosaic_part_big").hide();
            //this.mosaic_part_size = 5; //visszaugrott

...
<div class="col-sm-12 text-center ">
   <button id="btn_generate_image" type="button" class="btn btn-primary btn-sm" style="display:none;" @click="downloadMosaic()"  >Dev: Generate Image</button>
</div>
   <div v-if="generating_image_status === 'on'"  class=" ml-5" style="color:red;"> Generating image... </div>

<a id="btn_download_image" :href="mosaic_download_uri"  target="_blank" style="display:none;"><button  type="button" class="btn btn-success"   >Download Image</button></a>
  ...
  props: ['workuri'],
    ...
    methods: {
     ...
     // console.log('mosaic data: ' + this.mosaic_data.row + '  , ' + this.mosaic_data.col);
       ...
       if(this.mosaic_data.canvas_width > 1000) {
       this.mosaic_data.canvas_width = 1000;
       canvas_width  = 1000;
       }
       ...
       if(this.mosaic_data.canvas_height > 800) {
       this.mosaic_data.canvas_height = 800;
       canvas_height   = 800;
       }

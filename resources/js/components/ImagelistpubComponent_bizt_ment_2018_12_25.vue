  ...
  <div   v-if="images" class="row">
    <gallery :images="images" :index="index" @close="index = null"></gallery>
      ...
      >
         ...
         <a  @click="onoffpicture(image.id)" style=" cursor: pointer;color:black;background:white; opacity: 1 !important;">OFF/ON</a>  <a  @click="index = imageIndex" style=" cursor: pointer;color:black;background:#ccc; ">GALLERY</a><br>

<template>
    <div  class="container"   :key="varThatChangesValue">
        ...
        <div class="col-sm-12 my-2" ><!-- Gallery: {{selected_gallery_id }}-->  You can  upload 100 pictures.</div>

<!--{{this.$store.state.mainuri}}-->
        <div v-if="images.data.length  < 100" class="large-12 medium-12 small-12 filezone">
                    ...
                    formData.append('gallery_id', this.selected_gallery_id);
                        ...
                        if(this.files[this.files_index] !== undefined){
                          ...
                          //  console.log(this.files_index + " filename: "+ this.files[this.files_index].name )
                                    axios.post(this.uri+'/image/store',
                                    formData,
                                    {
                                        headers: {
